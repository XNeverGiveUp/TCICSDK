...
@property (nonatomic, copy, nullable) NSString *region;                                         // 节点地域, 支持 kTCICSDKRegionCN/kTCICSDKRegionSG, 传 nil 或非法值归一化为 cn
@property (nonatomic, copy, nullable) NSString *coreVersion;                                    // 课堂页H5版本号, 非必传; 默认 latest
